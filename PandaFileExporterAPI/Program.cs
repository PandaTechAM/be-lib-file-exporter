...
{
    new DummyTable { Id = 1, RelatedId = 18, Name = "Բարեւ բոլորին 1", Description = "Test this out, it's OK" },
    new DummyTable { Id = 2, RelatedId = 18, Name = "Բարեւ բոլորին 2", Description = "Test this out, it's OK" },
    ...
    new DummyTable { Id = 5, RelatedId = 18, Name = "Բարեւ բոլորին 5", Description = "Test this out, it's OK" },
    ...
    new DummyTable { Id = 10, RelatedId = 18, Name = "Բարեւ բոլորին 10", Description = "Test this out, it's OK" },
    ...
    new DummyTable { Id = 14, RelatedId = 18, Name = "Բարեւ բոլորին 14", Description = "Test this out, it's OK" },
    ...
    new DummyTable { Id = 17, RelatedId = 18, Name = "Բարեւ բոլորին 17", Description = "Test this out, it's OK" },
