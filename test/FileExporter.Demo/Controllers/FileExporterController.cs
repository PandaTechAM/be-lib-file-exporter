...
namespace FileExporter.Demo.Controllers
{
    ...
    public class FileExporterController(ApiDbContext context) : Controller
    {
        ...
        [HttpGet("export-pdf")]
        public IActionResult ExportPdf(bool headersOnEachPage = true, string fontName = "arial", int fontSize = 10,
            PageSize pageSize = PageSize.A4, PageOrientation pageOrientation = PageOrientation.Portrait)
        {
            var exportData = context.Dummies.AsEnumerable()
        ...
        public IActionResult ExportEmptyPdf(bool headersOnEachPage = true, string fontName = "arial", int fontSize = 10,
            PageSize pageSize = PageSize.A4, PageOrientation pageOrientation = PageOrientation.Portrait)
        {
            var exportData = context.EmptyTable.AsEnumerable()
                .ToPdf(headersOnEachPage, fontName, fontSize, pageSize, pageOrientation);
